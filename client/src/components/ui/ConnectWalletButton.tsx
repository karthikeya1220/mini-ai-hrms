    ...
    if (!isMetaMaskInstalled) {
        return (
            <a
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-700 text-slate-500 hover:border-slate-600 hover:text-slate-300 text-xs font-medium transition-all"
            ...
            {open && (
                <div
                    className="
                        ...
                        rounded-xl border border-slate-700/80 bg-slate-900/95
